...
| Lang | Repo | Generator | Package |
|---|---|---|---|
| Python | `hanzoai/python-sdk` | `python` | `hanzoai` on PyPI |
| Go | `hanzoai/go-sdk` | `go` | `github.com/hanzoai/go-sdk` |
| TypeScript | `hanzoai/js-sdk` | `typescript-axios` | `hanzoai` on npm |
| C++ · Dart | `hanzoai/cpp-sdk` · `hanzoai/dart-sdk` | `cpp-restsdk` · `dart-dio` | artifact |
| Rust | `hanzoai/rust-sdk` | hand-written | `hanzo` crate |
